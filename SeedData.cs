...
namespace EF.CreateDropAPI
{
    public static class SeedData
    {
        ...
        {
          new Schedule { Id = 1, Title = ScheduelEnum.Daily, SUN = true, MON = true, TUE = true, WED = true, THU = true, FRI = false, SAT = false },
          new Schedule { Id = 2, Title = ScheduelEnum.DayAfterDay, SUN = true, MON = false, TUE = true, WED = false, THU = true, FRI = false, SAT = false },
          new Schedule { Id = 3, Title = ScheduelEnum.TwiceAWeek, SUN = false, MON = true, TUE = false, WED = true, THU = false, FRI = false, SAT = false },
          new Schedule { Id = 4, Title = ScheduelEnum.Weekend, SUN = false, MON = false, TUE = false, WED = false, THU = false, FRI = true, SAT = true },
          new Schedule { Id = 5, Title = ScheduelEnum.Compact, SUN = true, MON = true, TUE = true, WED = true, THU = true, FRI = true, SAT = true }
        };
        ...
        {
            new Individual { Id = 1, FName = "Fatima", LName = "Ali",Univirstiy = "XYZ",     YearOfGraduate = 2024, IsIntern = false },
            new Individual { Id = 3, FName = "Omar", LName = "Youssef",  Univirstiy = "POQ",  YearOfGraduate = 2023, IsIntern = true },
            new Individual { Id = 5, FName = "Amira", LName = "Tariq",   Univirstiy = "POQ",   YearOfGraduate = 2025, IsIntern = false },
            new Individual { Id = 6, FName = "Zainab", LName = "Ismail", Univirstiy = "POQ", YearOfGraduate = 2023, IsIntern = true },
            new Individual { Id = 9, FName = "Mohammed", LName = "Adel", Univirstiy = "XYZ", YearOfGraduate = 2024, IsIntern = false },
            new Individual { Id = 10, FName = "Samira", LName = "Nabil", Univirstiy = "XYZ", YearOfGraduate = 2024, IsIntern = false }
        };
